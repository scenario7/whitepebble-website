...
const HeroSection = () => {
  return (
    <div className={`${marcellus.className} pt-10 lg:pt-20 flex flex-col lg:flex-row md:flex-row items-start justify-between gap-10 lg:gap-64 md:pl-10 lg:pl-10 bg-transparent`}>
        <div className='flex flex-col gap-20 items-start'>
            ...
            <button class="lg:text-lg text-white hover:before:bg-redborder-orange-500 relative p-2 lg:h-[50px] lg:w-40 overflow-hidden border border-orange-500 bg-orange-500 text-white-500 shadow-2xl transition-all before:absolute before:bottom-0 before:left-0 before:top-0 before:z-0 before:h-full before:w-0 before:bg-white before:transition-all before:duration-500 hover:text-orange-500 hover:shadow-[#FFEFE8] hover:before:left-0 hover:before:w-full"><span class="relative z-10">Contact Us</span></button>
            <button class="lg:text-lg text-orange-500 hover:before:bg-redborder-orange-500 relative p-2 lg:h-[50px] lg:w-40 overflow-hidden border border-orange-500 bg-white text-white-500 shadow-2xl transition-all before:absolute before:bottom-0 before:left-0 before:top-0 before:z-0 before:h-full before:w-0 before:bg-orange-500 before:transition-all before:duration-500 hover:text-white hover:shadow-[#FFEFE8] hover:before:left-0 hover:before:w-full"><span class="relative z-10">Learn More</span></button>
             </div>         
        </div>
        <div className={`${inter.className} flex flex-col items-end`}>
        <a href="#services">
        <button style={{'top':'-50%'}} class="hidden md:block lg:block px-2 mr-2 group relative min-h-[50px] w-40 overflow-hidden border border-orange-500 bg-black text-orange-500 shadow-2xl transition-all before:absolute before:left-0 before:top-0 before:h-0 before:w-1/4 before:bg-orange-500 before:duration-500 after:absolute after:bottom-0 after:right-0 after:h-0 after:w-1/4 after:bg-orange-500 after:duration-500 hover:text-white hover:before:h-full hover:after:h-full">
        ...
        <span class="absolute bottom-0 left-0 right-0 top-0 z-10 flex h-full w-full items-center justify-center group-hover:text-white">Explore Services <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="3" stroke="currentColor" class="w-4 h-4 ml-2"> <path stroke-linecap="round" stroke-linejoin="round" d="m4.5 19.5 15-15m0 0H8.25m11.25 0v11.25" /> </svg> </span>
            ...
            <img src='https://images.unsplash.com/photo-1589994965851-a8f479c573a9?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D' className=' object-cover lg:rounded-tl-2xl md:rounded-tl-2xl'/>
        </div>
    </div>
  )
}
